...
import static com.sbms.pdf.GenerateQuotePdf.quoteItemsFontSize;
...
public class DownloadQuotePdf extends AbstractView{
    @Resource
    private UserService userService;
    
    public static final String RESULT = "resources/quotes/new.pdf";
    ...
    protected void renderMergedOutputModel(Map<String, Object> map, HttpServletRequest request, HttpServletResponse response) throws Exception {
         ...
         Contact c = q.getContact();
          String filename = q.getQuoteUuid();
        ...
        try (Document pdfDocument = new Document(pdf)) {
            ...
            table.addCell(cellInfor("From :", co.getCompanyName(),
                    userService.getCurrentUser()==null ? "Sales": userService.getCurrentUser().getDisplayName(),
