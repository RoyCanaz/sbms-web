...
public class GenerateInvoice {
    ...
    public void save(Invoice i, String currentUser, String path, ServletContext context) throws Exception {
        
        Qoute q = i.getQoute();
       // String filename =  "src/main/webapp/resources/temp/"+i.getInvoiceUuid()+".pdf";
         ...
         PdfDocument pdf = new PdfDocument(pdfWriter);
          ...
          //  String imgPath = "src/main/webapp/resources/img/nice_logo.png";
            ...
            table.addCell(fromDetails(i.getInvoiceUuid(),
                   // DateUtil.currentDate(i.getDateCreated()),
                    DateUtil.currentDate(),
                    currentUser,
                    "0773394687", "200038664", "10019550"));
            table.addCell(cellInfor("From :", co.getCompanyName(), co.getAddress(), co.getEmail(), co.getOfficePhone() + co.getMobilePhone(), "", co.getWebsite()));
    ...
    public Cell fromDetails(String invoiceuuid, String dateCreated, String contactName, String phone, String bpn, String vat){
        ...
        .add("Quote No : "+invoiceuuid).add(NEWLINE)
