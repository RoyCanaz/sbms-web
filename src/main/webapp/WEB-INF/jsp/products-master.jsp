...
<body class="fixed-sn white-skin">
 ...
 <main>
        <div class="container-fluid">
                                  ...
                                  <c:choose>
                                      <c:when test="${clickNewComputers == true}"><%@include file="./products/new-computers.jsp" %></c:when>
                                      <c:when test="${clickNewConsumable == true}"> <%@include file="./products/new-consumable.jsp" %></c:when>
                                      <c:when test="${clickNewMonitor == true}"><%@include file="./products/new-monitor.jsp" %></c:when>                                    
                                      <c:when test="${clickNewAccessory == true}"> <%@include file="./products/new-accessory.jsp" %></c:when>
                                    <c:otherwise>
                                      <%@include file="./products/other.jsp" %>
                                    </c:otherwise>
