             ...
             <div class="md-form">
                ...
                <hr>
                         ...
                         <div class="md-form">
                             ...
                             <form:input path="compatibility" id="compatibility" class="form-control"/>
                             <label for="compatibility" class="font-weight-light">Compatibility</label>
                             <p class="help-block">
                              <form:errors path="compatibility" class="alert-danger"/>
                             </p>
                         </div> 
