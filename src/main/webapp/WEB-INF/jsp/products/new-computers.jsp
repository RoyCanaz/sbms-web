                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                        ...
                        <div class="md-form">  
                            ...
                            <c:choose>
                                  <c:when test="${not empty spec.processor}">
                                        <form:select path="processor" class="mdb-select">
                                             <form:option value="${spec.processor}" label="${spec.processor}" selected="true"/>
                                              <form:options items="${processorList}"/>                                
                                         </form:select>
                                 </c:when>
                               <c:otherwise>
                                    <form:select path="processor" class="mdb-select">
                                     <form:option value="" label="Select Processor"/>
                                      <form:options items="${processorList}"/>                                
                                    </form:select>
                                </c:otherwise>
                               </c:choose> 
                                ...
                                <p class="help-block">
                                    <form:errors path="processor" class="alert-danger"/>
                                </p>
                         </div>
                  </div> 
                  <div class="col-md-6">              
                        <div class="md-form">  
                            ...
                            <c:choose>
                                   <c:when test="${not empty spec.memory}">
                                        <form:select path="memory" class="mdb-select">
                                             <form:option value="${spec.memory}" label="${spec.memory}" selected="true"/>
                                              <form:options items="${memoryList}"/>                                
                                         </form:select>
                                  </c:when>
                               <c:otherwise>
                                 <form:select path="memory" class="mdb-select">
                                ...
                                <p class="help-block">
                                    <form:errors path="memory" class="alert-danger"/>
                                </p>
                       </div>
                  </div>
                </div>
                  <div class="form-row">
                      ...
                      <div class="col-md-6">
                            <div class="md-form">  
                               ...
                               <c:choose>
                                   <c:when test="${not empty spec.hardDrive}">
                                        <form:select path="hardDrive" class="mdb-select">
                                          <form:option value="${spec.hardDrive}" label="${spec.hardDrive}" selected="true"/>
                                           <form:options items="${hardDriveList}"/>                                
                                        </form:select>
                                   </c:when>
                                   <c:otherwise>
                                         <form:select path="hardDrive" class="mdb-select">
                                          <form:option value="" label="Select HardDrive"/>
                                           <form:options items="${hardDriveList}"/>                                
                                         </form:select>
                                   </c:otherwise>
                               </c:choose>
                                     ...
                                     <p class="help-block">
                                         <form:errors path="hardDrive" class="alert-danger"/>
                                     </p>
                            </div>
                      </div>
                      <div class="col-md-6">               
...
<!--                <center><h6 class="bg-primary "><strong><i>Recommended Addons</i></strong></h6></center>
                ...
                <%--    <div class="md-form">
                        <div class="form-check" style="margin-left: 100px">
                         <form:checkboxes class="test" path="addons" items="${addons}" itemValue="id" itemLabel="name"/>
                        </div>
