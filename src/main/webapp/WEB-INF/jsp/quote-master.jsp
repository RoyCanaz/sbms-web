...
<body class="fixed-sn white-skin">
 ...
 <main>
        <div class="container-fluid">
         ...
         <c:if test="${clickAddQuote == true}">
           <%@include file="./quote/quote-list.jsp" %>
          </c:if>
            
         <c:if test="${clickListAllQuotes == true}">
            <%@include file="./quote/list-all-quotes.jsp" %>
        </c:if>
       
         <c:if test="${clickSuccessNewQuote == true}">
            <%@include file="./quote/launch-new-quote.jsp"%>         
         </c:if>
           <c:if test="${clickEditQuote == true}">
            <%@include file="./quote/edit-quote.jsp"%>         
         </c:if>
          <c:if test="${clickNewQuote == true}">
            <%@include file="./quote/new-quote.jsp"%>         
         </c:if>
    ...
    <script src="<c:url value="/static/mdb/js/jQuery-3.2.1.min.js" />"></script>
     ...
     <script src="<c:url value="/static/custom/js/dataTables.select.min.js" />"></script>
     <script src="<c:url value="/static/custom/js/dataTables.checkboxes.min.js" />"></script>
     <script src="<c:url value="/static/custom/js/setting.checkbox.js"/>"></script>
        <script src="<c:url value="/static/custom/js/quote.js" />"></script>
