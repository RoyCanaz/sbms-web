...
<body class="fixed-sn white-skin">
 ...
 <main>
        ...
        <c:if test="${clickAddBankingDetails == true}">
            <%@include file="./forms/admin/add-bankingDetails.jsp"%>
        </c:if>
        <c:if test="${clickAddSupplier == true}">
            <%@include file="./products/new-supplier.jsp" %>
        </c:if>
         <c:if test="${clickListSuppliers == true}">
            <%@include file="./products/list-suppliers.jsp" %>
        </c:if>
         <c:if test="${clickListBanks == true}">
            <%@include file="./list/admin/list-banks.jsp" %>
        </c:if>
