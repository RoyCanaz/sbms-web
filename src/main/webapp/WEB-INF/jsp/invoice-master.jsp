...
<body class="fixed-sn white-skin">
 ...
 <main>
        <div class="container-fluid">
         ...
         <c:if test="${clickListClients == true}">
           <%@include file="./invoice/list-clients.jsp" %>
         </c:if>
          <c:if test="${clickListAllClients == true}">
           <%@include file="./invoice/list-invoices.jsp" %>
         </c:if>
          <c:if test="${clickListClientQuotes == true}">
           <%@include file="./invoice/client-quotes.jsp" %>
         </c:if>
          <c:if test="${clickViewInvoice == true}">
           <%@include file="./invoice/view-invoice.jsp" %>
         </c:if>
         <c:if test="${clickListClientInvoices == true}">
           <%@include file="./invoice/client-invoices.jsp" %>
         </c:if>
            <c:if test="${redirectSuccess == true}">
           <%@include file="./invoice/success-page.jsp" %>
         </c:if>
           <c:if test="${clickAllQuotes == true}">
           <%@include file="./quote/list-all-quotes.jsp" %>
         </c:if>
         <c:if test="${clickQuotes == true}">
           <%@include file="./quote/all-quotes.jsp" %>
         </c:if>
