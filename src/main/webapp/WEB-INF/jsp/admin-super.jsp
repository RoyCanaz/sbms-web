 ...
 <main>
        <div class="container-fluid">
         ...
         <c:if test="${clickAdminDashboard == true}">
           <%@include file="./adminSuper/admin-dashboard.jsp" %>
         </c:if>
           <c:if test="${clickAdminSales == true}">
           <%@include file="./adminSuper/sales-module.jsp" %>
         </c:if>
          <c:if test="${clickAddCurrency == true}">
           <%@include file="./forms/admin/product-rate.jsp" %>
         </c:if>
          <c:if test="${clickListCurrency == true}">
           <%@include file="./list/admin/list-currency.jsp" %>
         </c:if>
         <c:if test="${clickAddBrand == true}">
           <%@include file="./forms/admin/add-brand.jsp"%>
         </c:if>  
           <c:if test="${clickAddCategory == true}">
           <%@include file="./forms/admin/add-category.jsp"%>
         </c:if> 
             <c:if test="${clickListCompanyEmails == true}">
           <%@include file="./list/admin/list-company-emails.jsp"%>
         </c:if> 
            <c:if test="${clickAddCompanyEmail == true}">
           <%@include file="./forms/admin/default-email.jsp"%>
         </c:if> 
         <c:if test="${clickEditCcEmails == true}">
           <%@include file="./settings/add-cc.jsp"%>
         </c:if> 
             <c:if test="${clickAdminSetup == true}">
              <%@include file="./adminSuper/setup.jsp"%>
         </c:if> 
