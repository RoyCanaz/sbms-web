<ol class="breadcrumb white">
        ...
        <li class="breadcrumb-item active">Call/Visit Plan</li>       
</ol>
...
<ul class="nav nav-tabs nav-justified blue" role="tablist">
     <li class="nav-item">
        <a class="nav-link ${list}" data-toggle="tab" href="#panel5" role="tab"><i class="fa fa-list"></i>&nbsp; List</a>
    </li>
    <li class="nav-item">
...
<div class="tab-content">
    ...
    <div class="tab-pane fade ${showActiveList}" id="panel5" role="tabpanel">
                ...
                <div class="container">
                    ...
                    <tbody id="conDetails">
                        <c:forEach var="visit" items="${visitPlans}" varStatus="loop" >
                        <tr>
                            <th>${loop.count}</th>
        ...
        <form:form modelAttribute="visitForm" action="${contextPath}/visitplan/add" method="POST">         
                      ...
                      <c:if test="${not empty visitForm.id}">
                        ...
                        <div class="md-form">     
                         ...
                         <div class="md-form">  
                             <form:input type="date" path="dateVisit" required="required" class="form-control"/>
