                                                                 ...
                                                                 <c:if test="${viewInvoice==true}">
                                                                    ...
                                                                    <c:if test="${viewInvoice!=true}">
                                                                            <c:choose>
                                                                                        ...
                                                                                        <c:otherwise> 
                                                                                            <form action="${contextPath}/quote/edit/send" method="GET">
                                                                                                <input type="hidden" name="quoteId" value="${quoteId}">
                                                                                                   <button type="submit" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#modalLoginForm">Send Quote<i class="fa fa-angle-right right"></i></button>
                                                                                            </form>
                                                                                            </c:otherwise>
                                                                                  </c:choose>  
                                                                 </c:if>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="text-center">
                                    <a id="add-products-edit"><i class="fa fa-cart-plus fa-4x mb-3 animated rotateIn"></i></a>
