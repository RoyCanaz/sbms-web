<%-- 
    Document   : master
    Created on : 18-Jul-2018, 15:29:58
    Author     : user
--%>
...
<body class="fixed-sn white-skin">
 ...
 <main>
        <div class="container-fluid">
         ...
         <c:if test="${clickNewInvoiceList == true}">
           <%@include file="../invoice/new-invoice-list.jsp" %>
         </c:if>
            
            <c:if test="${clickNewInvoice == true}">
            <%@include file="../invoice/new-invoice.jsp"%>         
         </c:if>
    ...
    <script src="<c:url value="/static/mdb/js/jQuery-3.2.1.min.js" />"></script>
     ...
     <script src="<c:url value="/static/custom/js/invoice.js" />"></script>
